...
export default function AdminDashboardOverview({ stats, loading }: AdminDashboardOverviewProps) {
  const { totalPatients, pendingAlerts, adherenceRate } = stats;
  
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      {/* Total Patients Card */}
      <Link href="/admin/patients" className="block">
        <div className="bg-white rounded-lg shadow p-4 flex items-center hover:shadow-md transition-shadow duration-200 cursor-pointer">
